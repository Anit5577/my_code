...
#    ax.set(xlim=(-20., 20.), ylim=(-20., 20.))
    ...
    ax.scatter(dflist[n].loc[j,'radx'],dflist[n].loc[j,'rady'], s=5.0)
...
#               [(dflist[n].loc[j,'Unbound']== True) & (dflist[n].loc[j,'PM-velxy'] > 2.5)], s=15.0, c='goldenrod', label='Ejected stars')
...
#        text.set_color('#002342')
    plt.savefig('Cluster_check_%s.png' %dname[n])
plt.show()
